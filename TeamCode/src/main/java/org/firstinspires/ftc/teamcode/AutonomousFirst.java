...
@Autonomous(name="AutonomousFirst", group="Robot")
public class AutonomousFirst extends LinearOpMode {
    ...
    private DcMotor retraction=null;
    ...
    public void runOpMode() {
        ...
        retraction = hardwareMap.get(DcMotor.class, "hang");
        ...
        foldable.setDirection(DcMotor.Direction.REVERSE);
        retraction.setDirection(DcMotor.Direction.FORWARD);
        ...
        double position = 0;
        //turntime_right(.5,850);

        claw.setPower(1);
        moveForward(20,.5);
        sleep(1000);
        turntime_right(.5,430);
        moveForward(12,-.75);
        sleep(1000);

        Fold(170,initial_positionFold,.4);
        foldable.setPower(-.08);
        joint.setPosition(1);
        sleep(1000);
        openClaw();
        sleep(1000);
        ...
        moveForward(8,.5);
        turntime_left(.5,2000);
        Fold(260,initial_positionFold,.4);
        joint.setPosition(.6);
        sleep(1000);
        claw.setPower(-.5);
        ...
        claw.setPower(1);
        sleep(1000);
        Fold(120, encoderFold.getCurrentPosition(), -.4);
        turntime_left(.5,1400);
        moveForward(8,-.75);
        openClaw();
