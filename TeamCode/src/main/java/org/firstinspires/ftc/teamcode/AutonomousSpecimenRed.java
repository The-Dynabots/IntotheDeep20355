...
@Autonomous(name="AutonomousSpecimenRed", group="Robot")
public class AutonomousSpecimenRed extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        claw.setPower(1);
        moveForward(14,-.5);
        Fold(210,initial_positionFold,.4);
        joint.setPosition(1);
        sleep(1000);
        //moveForward(8,-.5);
        //Fold(230,initial_positionFold,.4);
        sleep(1000);
        ...
        leftFrontDrive.setPower(0);
        rightFrontDrive.setPower(0);
        Fold(10,initial_positionFold,-.4);
